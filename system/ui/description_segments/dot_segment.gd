...
const SIMPLE_TEMPLATE := "[color=%s]%d Stacks[/color] of [color=%s]%s[/color] at [color=%s]%d Base Damage[/color] for [color=%s]%d Turns[/color]"
const DETAILED_TEMPLATE := "[color=%s]%d Stacks[/color] of [color=%s]%s[/color] at [color=%s]%.2f Base Damage[/color] for [color=%s]%d Turns[/color]"
